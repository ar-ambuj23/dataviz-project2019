class Table{
    ...
    createTable(){
        ...
        //d3.select("#year").on("click",function(){that.sortDate();});
    ...
    //         if(that.dateFlag) return d3.ascending(parseInt(a.year),parseInt(b.year));
    //         return d3.descending(parseInt(a.year),parseInt(b.year));
    //     });
    //}
    sortState(){
    ...
    updateTable() {
        ...
        // //Create First Column
        // let th = table.selectAll("th").data((d, i) => [{name: d["Date Local"]}]);
        ...
        //State column
        let stateColumn = td.filter(d=>{ return d.vis == 'text';});
        ...
        //CO column
        let coColumn = td.filter(d=>{ return d.vis == 'CO';});
        ...
        //SO2 Column
        let so2Column = td.filter(d=>{ return d.vis == 'SO2';});
        ...
        //NO2 Column
        let no2Column = td.filter(d=>{ return d.vis == 'NO2';});
        ...
        //Ozone Column
        let OzoneColumn = td.filter(d=>{ return d.vis == 'Ozone';});
